...
PREFIX="${1:-transformer_nn_model_penal_mlp_light_grid_full_rolling}"
CONFIG="${2:-configs/transformer_nn_model_penal_mlp_light_grid.yaml}"
STRATEGY_DIR="${3:-reports/strategies/transformer_nn_model_penal_mlp_light_grid_advanced}"
