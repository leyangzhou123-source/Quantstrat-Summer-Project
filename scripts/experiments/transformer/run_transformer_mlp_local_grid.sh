...
PREFIX="${1:-transformer_nn_model_penal_mlp_local_grid_1987_1991}"
CONFIG="${2:-configs/transformer_nn_model_penal_mlp_local_grid.yaml}"
STRATEGY_DIR="${3:-reports/strategies/transformer_nn_model_penal_mlp_local_grid_1987_1991_advanced}"
